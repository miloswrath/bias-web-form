...
- [x] T014 Complete the end-to-end validation in `specs/001-web-survey/quickstart.md` steps 1–6: reset DB, override env vars, start dev server, submit a response, verify in Studio, view results page, test empty-state
